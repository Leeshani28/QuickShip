...
$result = $deliveryObj->getDailyDeliveryReport(
            $from_date,
            $to_date,
            $district_id
          );
...
$fpdf->SetTitle("Daily Delivery Report");
...
$fpdf->Cell(0,12,"DAILY DELIVERY REPORT",0,1,"C");
...
$fpdf->Cell(35,8,"From Date");

$fpdf->SetFont("Arial","",11);

$fpdf->Cell(50,8,$from_date);

$fpdf->SetFont("Arial","B",11);

$fpdf->Cell(30,8,"To Date");

$fpdf->SetFont("Arial","",11);

$fpdf->Cell(50,8,$to_date);
...
$fpdf->Cell(230,10,"TOTAL DELIVERIES",1,0,"R",true);
