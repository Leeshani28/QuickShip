...
$districtResult = $warehouseObj->getDestinationDistrictSummary();

$fpdf = new FPDF("P","mm","A4");
$fpdf->SetTitle("Destination Branch Report");
...
$fpdf->Cell(0,12,"DESTINATION BRANCH REPORT",0,1,"C");
...
$fpdf->Cell(0,10,"PARCELS BY DESTINATION BRANCH",0,1,"C",true);
...
$fpdf->Cell($districtWidth,10,"Destination Branch",1,0,"C",true);
...
$fpdf->Cell($districtWidth,10,"Total Parcels",1,0);
