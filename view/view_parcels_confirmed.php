        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="view_parcels.php">All</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link bg-primary" href="view_parcels_confirmed.php">Confirmed</a>
                    </li>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="../controller/warehouse_controller.php?status=atwarehouse_order&order_id=<?php echo $order_id; ?>" class="btn btn-info" style="background-color: #ae87e9;">
