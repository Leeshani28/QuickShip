...
$districtResult = $vehicleObj->getVehiclesByDistrictReport();

$fpdf = new FPDF("P","mm","A4");
$fpdf->SetTitle("Vehicles by Branch Report");
...
$fpdf->Cell(0,12,"VEHICLES BY BRANCH REPORT",0,1,"C");
...
$fpdf->Cell(0,10,"VEHICLES BY BRANCH",0,1,"C",true);
...
$fpdf->Cell($districtWidth,10,"Total Vehicles",1,0);
