...
$deliveryResult = $deliveryObj->getStartedDeliveries($warehouse_location);
    ...
    <body>
        ...
        <div class="row">
            <div class="col-md-5">
                ...
                <li class="nav-item">
                    <a class="nav-link bg-primary " href="incoming_deliveries.php">Incoming</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="received_deliveries.php">Received</a>
                </li>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="../controller/delivery_controller.php?status=receive_delivery&delivery_id=<?php echo $delivery_id; ?>" class="btn btn-info">
