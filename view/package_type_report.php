...
$orderObj = new Order();
$result = $orderObj->getOrdersByPackageType();

include '../commons/fpdf186/fpdf.php';

$fpdf = new FPDF("P","mm","A4");
$fpdf->SetTitle("Orders by Package Type Report");
...
$fpdf->Cell(0,12,"ORDERS BY PACKAGE TYPE REPORT",0,1,"C");
...
$fpdf->Cell(70,10,"Package Type",1,0,"C",true);
