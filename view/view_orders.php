...
$orderResult = $orderObj->getAllOrders($userrow["user_location"]);
    ...
    <div class="col-md-5">
        ...
        <div class="row">
            <ul class="nav nav-pills">
                <li class="nav-item">
                    <a class="nav-link bg-primary" aria-current="page" href="view_orders.php">All</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="view_pending_orders.php">Pending Orders</a>
                </li>
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-info table-striped" id="ordertable">
                        <thead>
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if ($orderrow["order_status"] == 1) {
                                            ...
                                            <a href="../controller/order_controller.php?status=confirm_order&order_id=<?php echo $order_id; ?>"
                                                class="btn btn-info">
                                            ...
                                            <a href="#" data-toggle="modal" data-target="#myModal" class="btn btn-danger"
                                                onclick="cancelorder('<?php echo $order_id; ?>');"><span
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../controller/order_controller.php?status=delete_order" method="post">
