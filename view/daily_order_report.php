...
$result = $orderObj->getDailyOrderSummaryReport($from, $to);

include '../commons/fpdf186/fpdf.php';

$fpdf = new FPDF("L","mm","A4");

$fpdf->SetTitle("Daily Order Summary Report");
...
$fpdf->Cell(0,12,"DAILY ORDER SUMMARY REPORT",0,1,"C");
...
$fpdf->Cell(45,10,"Town",1,0,"C",true);
...
$fpdf->Cell(50,10,"Count",1,1,"C",true);
...
{
    $fpdf->SetX($summaryX);
    $fpdf->Cell(70,9,$label,1,0);
    $fpdf->Cell(50,9,$count,1,1,"C");
}
