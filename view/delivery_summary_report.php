...
$result = $deliveryObj->getDeliveryStatusSummary();

include '../commons/fpdf186/fpdf.php';

$fpdf = new FPDF("P","mm","A4");
$fpdf->SetTitle("Delivery Status Summary Report");
...
$fpdf->Cell(0,12,"DELIVERY STATUS SUMMARY REPORT",0,1,"C");
...
$fpdf->Cell(70,10,"Delivery Status",1,0,"C",true);
$fpdf->Cell(50,10,"Total Deliveries",1,1,"C",true);
