...
$warehouseResult = $warehouseObj->getPendingOfd($driver_id);
    ...
    <div class="container">
        ...
        <div class="row">
            <ul class="nav nav-pills">
                <li class="nav-item">
                    <a class="nav-link bg-primary" aria-current="page" href="driver_dashboard.php">All</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="driver_completed_tasks.php">Completed Tasks</a>
                </li>
                                    ...
                                    <table class="table table-info table-striped" id="driverdeliverytable"
                                        ...
                                        <tbody>
                                            ...
                                            while ($ofdrow = $warehouseResult->fetch_assoc()) {
                                                ...
                                                } elseif ($ofdrow["ofd_status"] == "Confirm") {
                                                    $color = "bg-success";
