    ...
    <body>
        <div class="container">
            ...
            <tbody>
                ...
                <tr>
                    <th>Location</th>
                    <td><?php echo $userdetailrow["branch_name"];?></td>
                </tr>
                <tr>
                    <th>Status</th>
                    <td
...
<div class="row">
        ...
        <div class="row" style="display: flex; justify-content: center; align-items: center;padding-right:70;height:40px;">
            <?php $user_id=base64_encode("$user_id");?>
            <div class="col-md-5">
                <a href="edit_user.php?user_id=<?php echo $user_id; ?>" type="button" class="btn btn-danger" style="width:100%"><span
