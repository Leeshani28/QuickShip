...
$result = $customerObj->getCustomerStatusSummary();

include '../commons/fpdf186/fpdf.php';

$fpdf = new FPDF("P","mm","A4");
$fpdf->SetTitle("Customer Status Report");
...
$fpdf->Cell(0,12,"CUSTOMER STATUS REPORT",0,1,"C");
...
$fpdf->Cell(70,10,"Customer Status",1,0,"C",true);
$fpdf->Cell(50,10,"Total Customers",1,1,"C",true);
...
while($row = $result->fetch_assoc())
{
    ...
    $fpdf->Cell(
        50,
        10,
        number_format($row["total_customers"]),
        1,
        1,
        "C"
    );
