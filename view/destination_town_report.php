...
$orderObj = new Order();
$result = $orderObj->getOrdersByDestinationTown();

include '../commons/fpdf186/fpdf.php';

$fpdf = new FPDF("P","mm","A4");

$fpdf->SetTitle("Orders by Destination Town Report");
...
$fpdf->Cell(0,12,"ORDERS BY DESTINATION TOWN REPORT",0,1,"C");
...
$fpdf->Cell(70,10,"Destination Town",1,0,"C",true);
