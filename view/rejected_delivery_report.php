...
$result = $deliveryObj->getRejectedDeliveryReport(
            $from_date,
            $to_date,
            $district_id
          );
...
$fpdf->SetTitle("Rejected Delivery Report");
...
$fpdf->Cell(0,12,"REJECTED DELIVERY REPORT",0,1,"C");
...
$fpdf->Cell(230,10,"TOTAL REJECTED DELIVERIES",1,0,"R",true);
