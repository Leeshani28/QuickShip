...
$statusResult = $warehouseObj->getWarehouseStatusSummary();

$fpdf = new FPDF("P","mm","A4");
$fpdf->SetTitle("Warehouse Status Summary Report");
...
$fpdf->Cell(0,12,"WAREHOUSE STATUS SUMMARY REPORT",0,1,"C");
...
$fpdf->Cell(0,10,"WAREHOUSE STATUS SUMMARY",0,1,"C",true);
...
$fpdf->Cell($statusWidth,10,"Warehouse Status",1,0,"C",true);
...
while($row=$statusResult->fetch_assoc())
{
    ...
    $fpdf->Cell($statusWidth,9,$row["status_name"],1,0);
...
$fpdf->Cell($statusWidth,10,"Total Parcels",1,0);
