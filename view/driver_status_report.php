...
$statusResult = $driverObj->getDriverStatusSummary();

$fpdf = new FPDF("P","mm","A4");
$fpdf->SetTitle("Driver Status Summary Report");
...
$fpdf->Cell(0,12,"DRIVER STATUS SUMMARY REPORT",0,1,"C");
...
$fpdf->Cell(0,10,"DRIVER STATUS SUMMARY",0,1,"C",true);
...
$fpdf->Cell($statusWidth,10,"Driver Status",1,0,"C",true);
...
while($row=$statusResult->fetch_assoc())
{
    ...
    $fpdf->Cell($statusWidth,9,$row["driver_status"],1,0);
